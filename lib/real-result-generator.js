...
export const generateRealResult = (answers, spotifyData) => {
  ...
  if (finalScore >= 85) {
    ...
    return {
      ...
      subtitle: "Predictably Mediocre | NPC Energy",
      ...
      verdict: `Looking at your real data: ${topTrack} on repeat? ${topGenre} as your main genre? You're the musical equivalent of unseasoned chicken.`,
